...
class Track {
    ...
    trackConference(conference) {
        ...
        if (conference.duration <= this.morningDuration) {
            ...
            this.morningSlot.push(`${this.morningTime.toString()} ${conference.topic}`);
        ...
        // Checks if the conference can fit in the afternoon duration
            ...
            this.afternoonSlot.push(`${this.afternoonTime.toString()} ${conference.topic}`);
     ...
     */
    prepareTrack() {
        this.morningSlot.push(`${this.lunchTime.toString()} Lunch`);
        if (this.afternoonDuration === 0) {
            this.afternoonSlot.push(`${this.networkingDeadline.toString()} Networking Event`);
        } else if (this.afternoonDuration < this.afternoonMaxDuration - this.afternoonMinDuration) {
            this.afternoonSlot.push(`${this.afternoonTime.toString()} Networking Event`);
        } else {
            this.afternoonSlot.push(`${this.networkingTime.toString()} Networking Event`);
        }
