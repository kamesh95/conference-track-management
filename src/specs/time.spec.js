...
describe('Time', () => {
    ...
    describe('#add()', () => {
        ...
        context('When added minutes exceed 60 and hours are greater than 12 with PM time of day', () => {
            let timestring = '11:55PM';
            before(() => timestring = _before(timestring, 100));

            it('Should return proper time', () => {
                expect(timestring).to.be.equals('01:35AM');
            });
        });

        context('When added minutes exceed 60 and hours are greater than 12 with AM time of day', () => {
            let timestring = '11:55AM';
            before(() => timestring = _before(timestring, 100));

            it('Should return proper time', () => {
                expect(timestring).to.be.equals('01:35PM');
            });
        });
    });
});
